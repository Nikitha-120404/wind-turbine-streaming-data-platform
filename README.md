...
A production-grade real-time streaming platform for wind turbine telemetry, anomaly detection, and operational monitoring. Built on Apache Kafka, TimescaleDB, FastAPI, Prometheus, and Grafana — fully runnable locally with Docker Compose.
